...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='ASCNet-GZ', type=str)
    parser.add_argument('--checkpoint_root', default='/data/cd/checkpoints', type=str)

    # data
    parser.add_argument('--num_workers', default=16, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='GZ', type=str)
    ...
    parser.add_argument('--net_G', default='ASCNet', type=str,
                        help='ASCNet')
